...
bool SenarioChooseScene::init()
{
    ...
    CCLabelTTF* senarioLabel1 = CCLabelTTF::create("Senario 1", "Shojumaru-Regular" ,96, senarioButtonS1->boundingBox().size, kCCTextAlignmentCenter, kCCVerticalTextAlignmentCenter);
    ...
    CCLabelTTF* senarioLabel2 = CCLabelTTF::create("Senario 2", "Shojumaru-Regular" ,96, senarioButtonS2->boundingBox().size, kCCTextAlignmentCenter, kCCVerticalTextAlignmentCenter);
    ...
    CCLabelTTF* senarioLabel3 = CCLabelTTF::create("Senario 3", "Shojumaru-Regular" ,96, senarioButtonS3->boundingBox().size, kCCTextAlignmentCenter, kCCVerticalTextAlignmentCenter);
    ...
    CCLabelTTF* senarioLabel4 = CCLabelTTF::create("Senario 4", "Shojumaru-Regular" ,96, senarioButtonS4->boundingBox().size, kCCTextAlignmentCenter, kCCVerticalTextAlignmentCenter);
    ...
    CCLabelTTF* senarioLabel5 = CCLabelTTF::create("Senario 5", "Shojumaru-Regular" ,96, senarioButtonS5->boundingBox().size, kCCTextAlignmentCenter, kCCVerticalTextAlignmentCenter);
